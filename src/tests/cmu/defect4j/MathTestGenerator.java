...
public class MathTestGenerator extends TestGenerator {
    ...
    private String config = "\"+interaction=interaction\", \"+search.class= .search.RandomSearch\", \"+nhandler.delegateUnhandledNative\", \"+classpath+=${jpf-core}/lib/junit-4.11.jar,lib/math7b.jar\"";
